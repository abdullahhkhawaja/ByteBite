...
public class LoginResource {
    ...
    public Response signUp(User user) throws SQLException {
        ...
        boolean emailExists = UserDAO.CheckIfEmailAlreadyUsed(email);
        if (emailExists) {
            return Response.status(Response.Status.BAD_REQUEST)
        ...
        boolean inserted = UserDAO.SignUp(name, email, hashedPassword);
    ...
    @Path("/login")
        ...
        @Produces(MediaType.APPLICATION_JSON)
        @Consumes(MediaType.APPLICATION_JSON)
        public static Response login(User loginRequest) {
